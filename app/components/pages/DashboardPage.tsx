                  ...
                  <div className="relative mb-1" ref={serverDropdownRef}>
                    ...
                    {serverDropdownOpen && (
                      <div className="pb-menu absolute right-0 top-full z-50 mt-2 w-64 rounded-lg p-2">
                        ...
                        {/* Privileged actions: only render when the viewer
                            actually has the corresponding privilege. Hidden
                            (not disabled) so the menu doesn't expose the
                            privilege catalog to non-privileged users. */}
                        {canCreateInvite && (
                          <button
                            onClick={() => {
